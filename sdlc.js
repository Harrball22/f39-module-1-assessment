...
const analysisOfRequirements = "Analysing the end goals requirements"
const design = "Creating a design of what the finished product should look like"
const implementation = "The actual codeing of the software"
const testingAndIntegration = "Testing the software to make sure it works properly"
const maintain = "Keeping the software up to date and fixing any bugs that have come up since release"